...
export default function MoneyScoreQuizClient() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-xl bg-[#0f172a] border border-gray-800 rounded-2xl shadow-2xl shadow-black/40 p-8">
        {step === -1 && (
          <div className="text-center py-8">
            <p className="text-sm font-semibold text-emerald-400 uppercase tracking-wide mb-3">
              Free 2-Minute Quiz
            </p>
            ...
            <button
              onClick={start}
              className="px-8 py-4 rounded-xl bg-emerald-500 text-black font-semibold text-lg hover:bg-emerald-400 transition-colors"
            >
              Start the Quiz
            </button>
          </div>
            ...
            <div className="space-y-3">
              {question.options.map((option, index) => (
                <button
                  ...
                  className="w-full text-left px-5 py-4 rounded-xl border border-gray-700 bg-[#020617] hover:border-emerald-400 hover:bg-emerald-500/10 transition-colors font-medium text-gray-200"
                >
                  {option.label}
                </button>
              ))}
