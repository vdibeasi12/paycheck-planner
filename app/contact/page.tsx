      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {status === "success" ? (
              <div className="bg-green-500/10 border border-green-500/40 rounded px-4 py-3 text-green-400">
                Thanks -- your message has been sent. We'll get back to you within 24-48 hours.
              </div>
            ) : (
              <form className="space-y-4" onSubmit={handleSubmit} noValidate>
                ...
                <button
                  ...
                  className="w-full bg-green-500 hover:bg-green-600 disabled:opacity-60 disabled:cursor-not-allowed text-black font-semibold py-2 rounded transition"
                >
