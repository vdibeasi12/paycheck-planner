        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <label className="block">
              <span className="text-xs font-medium text-slate-500">Target amount</span>
              <div className="mt-1 flex items-center rounded-lg border border-slate-300 px-3 focus-within:border-emerald-400">
            ...
            <label className="block sm:col-span-2">
              <span className="text-xs font-medium text-slate-500">Target date (optional)</span>
              <input
                type="date"
                value={deadline}
          ...
          <button
            ...
            onClick={addGoal}
            disabled={busy}
            className="mt-4 flex items-center justify-center gap-2 rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-60"
          >
    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4">
        <div className="mb-1 flex items-baseline justify-between text-sm">
          ...
          <span className={`font-semibold ${done ? "text-emerald-600" : "text-slate-500"}`}>
            {progress}%
          </span>
        </div>
      ...
      {!done && (
        <div className="mt-4 flex gap-2">
          <div className="flex flex-1 items-center rounded-lg border border-slate-300 px-3 focus-within:border-emerald-400">
            <span className="text-slate-400">$</span>
            <input
              value={amt}
