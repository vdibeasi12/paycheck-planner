...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${base}/best-budgeting-apps-paycheck-to-paycheck`,
      lastModified: now,
  ...
  // Comparison pages (Aug 2026 growth-plan engine #3). Add an entry to
  // lib/comparisons.ts and it's indexable here automatically.
